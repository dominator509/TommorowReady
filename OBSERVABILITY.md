...
Metrics cover authentication, authorization denials, cross-tenant attempts, uploads, malware results, extraction confirmation, readiness calculation, packet generation, continuity check-ins, reminders, release-state transitions, challenge timers, owner notifications, digital delivery, physical-mail acceptance and delivery events, denials, manual reviews, downloads, revocations, AI cache tokens, AI cost, queue age, backups, restores, and deletion.

Alerts include unauthorized-release attempt, unusual recipient velocity, owner-notification failure during active challenge, continuity scheduler lag, physical-mail ambiguous submission, physical-mail delivery failure, packet isolation failure, repeated verification ambiguity, KMS failure, backup failure, purge failure, malware spike, and cross-tenant policy denial spike.
